...
function Portfolio() {
  ...
  return (
    <section 
      className="work-fade section-padding sub-bg bord-top-grd bord-bottom-grd"
      style={{
        background: 'radial-gradient(ellipse at center, rgba(255, 204, 0, 0.1) 0%, rgba(255, 204, 0, 0.05) 30%, rgba(255, 204, 0, 0.02) 60%, transparent 100%)',
        position: 'relative'
      }}
    >
