            ...
            <div className="row lg-marg align-items-center">
              ...
              <div className="col-md-6">
                <div className="text">
                  ...
                  <p>
                  Technology is only valuable when it works for people.
                   That’s why we build custom solutions designed around your goals
                    — ensuring every project is functional, intuitive, and future-ready.
                  </p>
            ...
            <div className="numbers mt-80">
              <div className="row lg-marg">
                ...
                <div className="col-md-6">
                  <div className="item bord-thin-top pt-30 d-flex align-items-end mt-20">
                    <div>
                      <h3 className="fw-300 mb-10">over 67</h3>
